...
function updateLocalStorage(data) {
  if(window.localStorage !== null) {
    ...
    window.localStorage.setItem("codingclub-collections", JSON.stringify(data));
  }
}

function getLocalStorage() {
  // window.localStorage.setItem("codingclub-collections", null);

  let data = {};
  if(window.localStorage !== null) {
    if(JSON.parse(window?.localStorage?.getItem("codingclub-collections")))
      data = JSON.parse(window.localStorage.getItem("codingclub-collections"));
    else {
      data = {
        bookmarks: [],
        collectionOrder: [],
