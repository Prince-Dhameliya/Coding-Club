    ...
    <div className="min-h-screen bg-image w-full text-[#ECF2F5] overflow-visible z-10">
      ...
      <div className="flex items-center justify-center h-auto min-h-[90vh] lg:h-[90vh] xl:h-[90vh] w-full flex-col lg:flex-row xl:flex-row overflow-hidden">
        <div className="w-full lg:w-6/12 xl:w-6/12 h-auto lg:h-full xl:h-full flex items-start justify-center flex-col pl-4 lg:pl-10 xl:pl-10 relative z-10 py-4 lg:py-0 xl:py-0 overflow-hidden animate__animated animate__fadeInLeft">
          ...
          <p className="text-light text-[#aaa] my-2 mt-5 text-xl lg:text-sm xl:text-sm">
            The MSU Coding Club is a vibrant community of tech enthusiasts and aspiring programmers
            at Maharaja Sayajirao University. This student-led organization provides a platform for students to
            enhance their coding skills, collaborate on projects, and stay up-to-date with the latest technology trends.
            Members of the MSU Coding Club engage in coding challenges, hackathons, and workshops, fostering a supportive environment
            for learning and networking in the world of software development. It's a fantastic place for students to expand their 
            coding knowledge and gain valuable experience in the field. 🤟
          </p>
