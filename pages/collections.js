...
function Collections(props) {
  ...
  return(
    <div className="relative bg-image">
      ...
      <Head>
        <title>
          {`Collections (${entities ? entities.collectionOrder.length : 0})`} - Coding Club
        </title>
      </Head>
      <Header {...props} />
      <SvgBanner
        text={`Your Collections (${entities ? entities.collectionOrder.length : 0})`}
        description="These are the collections of your bookmarked resources, you can move stuff around by dragging and dropping them 🤟"
